...
import com.ptit.aird18bookingapp.listeners.BaseResponseListener;
...
import com.ptit.aird18bookingapp.repository.ServiceImpl;
...
private final LoginResponseListener loginResponseListener = new LoginResponseListener() {
    ...
    public void didFetch(UserResponse userResponse, String message, String cookie) {
        if (userResponse != null && userResponse.error == null && userResponse.data != null) {
            ...
            String errorMsg = (userResponse != null && userResponse.error != null) ? userResponse.error.toString() : "Unknown error";
